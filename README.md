# Generative AI: To search, summarize, to analyze the thought process of the customer by logging input queries. Used prompt engineering techniques for implementation
